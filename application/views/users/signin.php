            ...
            <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent-3">
                <div class="row w-100 mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto w-100">
                        <img src="<?php echo base_url();?>/assets/images/media/pngs/5.png"
                            ...
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    <div class="mb-5 d-flex">
                                        <a href="index.html" class="header-logo"><img src="<?php echo base_url();?>/assets/images/brand-logos/desktop-logo.png"
                                            class="desktop-logo ht-40" alt="logo">
                                            <img src="<?php echo base_url();?>/assets/images/brand-logos/desktop-white.png"
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            ...
                                            <div class="main-signin-footer mt-5">
                                                <p class="mb-1"><a href="<?php echo base_url() ?>users/forgot_password">Forgot password?</a></p>
                                                <p>Don't have an account? <a href="<?php echo base_url() ?>index.php/users/register">Create an
                                                        Account</a></p>
                                            </div>
                                        </div>
                                    </div>
